...
Once the server is running, the portal is accessible via your web browser. Do **not** open the HTML files directly from your folder; they must be served through the local server to handle API requests correctly.

* **URL**: [http://localhost:3000/index.html](https://www.google.com/search?q=http://localhost:3000/index.html)
